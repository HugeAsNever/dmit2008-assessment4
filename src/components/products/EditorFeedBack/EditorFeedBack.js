...
function EditorFeedBack ({children, status,writeCompleted, ...props})  {
  ...
  return (
        <EditorFeedBackStyles  {...props}>
          ...
          <FeedBackOption>
            <Button bc="tomato" color='white' onClick={() => writeCompleted(false)} disabled={status} >Add Another Product</Button>
            <Button bc="cornflowerblue" color='white' onClick={() => navigator('/dashboard')}>View All Products</Button>
          </FeedBackOption>
